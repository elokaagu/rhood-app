...
if (process.argv.length < 5) {
  ...
  console.log("Usage:");
  console.log(
    "  node scripts/convert-apple-key-to-jwt.js <p8-file> <team-id> <key-id>\n"
  );
  console.log("Example:");
  console.log(
    "  node scripts/convert-apple-key-to-jwt.js ./AuthKey_AB12CD34EF.p8 ABC1234DEF AB12CD34EF\n"
...
if (!/^[A-Z0-9]{10}$/.test(keyId)) {
  ...
  console.log(
    "Find your Key ID in Apple Developer Console when you created the key\n"
  );
  process.exit(1);
}
...
try {
  ...
  console.log(
    "Copy the ENTIRE content below (including BEGIN and END lines):\n"
  );
  console.log("─────────────────────────────────────────────────────────\n");

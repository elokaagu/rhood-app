...
export const privacySections = [
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        bullets: [
          "Usage Data: Details about how you use the Platform (pages visited, time spent, features used). We use first-party analytics (including Mixpanel and crash reporting) to improve R/HOOD. We do not use this data to track you across other companies' apps or websites for advertising.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Track earned in-app credits used to boost gig applications. We do not process credit-card payments in the app.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "With Service Providers: Trusted partners who assist with hosting, analytics, or communication (bound by confidentiality agreements).",
  ...
  },
  {
    ...
    content:
      "We retain personal data only as long as necessary to provide our services or comply with legal obligations. You can delete your account at any time from Settings, from the onboarding flow, or from the application-status screen. Deleting your account permanently removes your data (subject to any legal retention requirements).",
  },
  {
    title: "5. Your Rights",

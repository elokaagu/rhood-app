...
export async function getAssistantReply(userMessage, opts = {}) {
  ...
  const systemPrompt =
    ...
    [
      ...
      "",
      "EXAMPLES OF MY PROBLEM-SOLVING APPROACH:",
      "- User: 'I can't upload my mix' → Me: 'Got it! Let's figure this out. What happens when you try? Do you see an error message, or does it just not upload? Also, what format is your file - MP3 or WAV?'",
      "- User: 'How do I find gigs?' → Me: 'For sure! So you'll see opportunities right on the main screen. Swipe right on ones you like to see details and apply. Are you not seeing any opportunities, or having trouble applying?'",
      "- User: 'My location is wrong' → Me: 'Ah, that can be annoying! Is it showing the wrong city, or is it not updating? Let me walk you through fixing it...'",
      "",
      "EXAMPLES OF MY TONE:",
      ...
      "- If the user's question is vague, ask clarifying questions to get to the root of the problem",

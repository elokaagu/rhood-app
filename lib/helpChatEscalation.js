...
export function shouldEscalateHelpChat(message = "") {
  const text = String(message || "").toLowerCase();
  return ESCALATION_KEYWORDS.some((keyword) => text.includes(keyword));
}

export function getHelpChatEscalation(message = "") {
  if (!shouldEscalateHelpChat(message)) return null;
  return {
    shouldEscalate: true,
    title: "Need more help?",
    message:
      "This looks like something our support team should handle directly. Please contact hello@rhood.io and they'll help you out.",

...
export function normalizeTrackForPlayback(track) {
  ...
  const image =
    ...
    (typeof t.artwork_url === "string" && t.artwork_url.trim() && t.artwork_url) ||
    (typeof t.image_url === "string" && t.image_url.trim() && t.image_url) ||
    (typeof t.cover_url === "string" && t.cover_url.trim() && t.cover_url) ||
    null;

  ...
  [APP_TUTORIAL_SCREEN_IDS.CONNECTIONS]: {
    ...
    rows: [
      row(
        "people",
        "Discover & Connect",
        "Use the tabs to switch between Discover (find DJs) and Connections (people you’re linked with)."
      ),
      row(
        "chatbubbles-outline",
        "Messages",
  ...
  [APP_TUTORIAL_SCREEN_IDS.MESSAGES]: {
    ...
    rows: [
      ...
      row(
        "chevron-back",
        "Leave",
        "Swipe from the left edge or use back to return to Connections."
      ),
    ],
  },

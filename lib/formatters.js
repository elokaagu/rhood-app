...
export const formatOpportunityDate = (dateValue) => {
  ...
  try {
    ...
    // (already timezone-aware) fall through to the normal Date parse.
    const dateOnlyMatch =
...
export const formatOpportunityTime = (startValue, endValue = null) => {
  const sanitize = (value) => {
    ...
    if (typeof value === "string") {
      ...
      // Use UTC so a posted 00:00 stays midnight on every device, matching Studio.

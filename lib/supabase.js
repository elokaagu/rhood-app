...
export const auth = {
  ...
  async signInWithApple() {
    ...
    try {
      ...
      console.log("🔐 Fixed nonce length:", rawNonce.length);
      console.log("🔐 Fixed hashed nonce (base64url):", hashedNonceB64Url);
      console.log("🔐 Fixed hashed nonce length:", hashedNonceB64Url.length);
      ...
      if (error) {
        ...
        try {
          ...
          if (res.status === 200) {
            console.log(
              "✅ REST call succeeded - SDK likely dropped the nonce"
            );

...
export const db = {
  ...
  async getUserProfile(userId) {
    const { data, error } = await supabase
      .from("user_profiles")
      .select(
        "id, dj_name, full_name, first_name, last_name, email, bio, status_message, location, city, genres, profile_image_url, phone, show_email, show_phone, primary_mix_id, credits, created_at, updated_at, username, is_verified, gigs_completed, instagram, soundcloud, tiktok, youtube"
      )
      .eq("id", userId)
      .single();

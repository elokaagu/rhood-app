...
export const auth = {
    ...
    try {
      ...
      if (result.type === "success") {
        ...
        if (accessToken) {
          ...
          if (isSignupFlow) {
            console.log("📝 Signup flow detected - checking/creating profile...");
            try {
              console.log(
            ...
            console.log("🔐 Login flow detected - letting handleLoginSuccess manage profile check");
          }
  ...
  async signInWithApple() {
    ...
    try {
      ...
      // 1) Raw nonce as 32 random bytes → 64-char hex (Expo-safe)

...
export const auth = {
  ...
  async signInWithApple() {
    ...
    try {
      ...
      if (error.message.includes("localhost") || error.message.includes("redirect")) {
        console.log("⚠️ Redirect URL issue detected - this might be a TestFlight/configuration issue");
      }
      ...
      try {
        ...
        if (webError.message.includes("localhost") || webError.message.includes("redirect")) {
          throw new Error("Apple Sign-In configuration issue. Please try again or use email sign-in.");
        }

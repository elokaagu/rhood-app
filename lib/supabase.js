      ...
      if (result.type === "success") {
        ...
        if (accessToken) {
          ...
          try {
            ...
            if (!existingProfile) {
              console.log("📝 Creating user profile from Google data...");
    ...
    try {
      ...
      if (result.type === "success") {
        ...
        const error = url.searchParams.get("error") || 
                      (url.hash ? new URLSearchParams(url.hash.substring(1)).get("error") : null);
        const errorDescription = url.searchParams.get("error_description") || 
                                 (url.hash ? new URLSearchParams(url.hash.substring(1)).get("error_description") : null);
        ...
        if (accessToken) {
          ...
          try {
            ...
            if (!existingProfile) {
              console.log("📝 Creating user profile from Apple data...");

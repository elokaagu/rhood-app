...
export const auth = {
  ...
  async signInWithGoogle() {
    try {
      // Temporary: OAuth disabled until WebBrowser module is fixed
      throw new Error("Google OAuth temporarily disabled - WebBrowser module issue");
    } catch (error) {
  ...
  async signInWithApple() {
    try {
      // Temporary: OAuth disabled until WebBrowser module is fixed
      throw new Error("Apple OAuth temporarily disabled - WebBrowser module issue");
    } catch (error) {

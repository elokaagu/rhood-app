      ...
      if (result.type === "success") {
        ...
        if (accessToken) {
          ...
          try {
            ...
            if (!existingProfile) {
              ...
              if (emailProfile) {
                ...
                const { error: updateError } = await supabase
                  ...
                  .update({
                    ...
                    profile_image_url:
                      ...
                      emailProfile.profile_image_url,
                ...
                console.log(
                  "🆕 New user - creating profile from Google data..."
                );
          ...
          try {
            ...
            if (finalCheck) {
              console.log("✅ Profile verified in database:", finalCheck.dj_name);
            } else {
              console.warn("⚠️ Profile not found in final check - user may see onboarding");
            }
          } catch (verifyError) {
            console.warn("⚠️ Profile verification failed:", verifyError.message);
          }

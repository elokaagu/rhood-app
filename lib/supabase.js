        ...
        if (accessToken) {
          ...
          try {
            ...
            if (!existingProfile) {
              ...
              console.log("🔍 Checking if this is a returning user by email...");
              ...
              if (emailProfile) {
                console.log("✅ Found existing profile with same email - returning user!");
                console.log("🔗 Linking Google account to existing profile...");
                ...
                const { error: updateError } = await supabase
                  ...
                  .update({ 
                    ...
                    profile_image_url: sessionData.user.user_metadata?.avatar_url || emailProfile.profile_image_url,
                ...
                console.log("🆕 New user - creating profile from Google data...");

                // Create basic profile from Google user data
          ...
          try {
            ...
            if (!existingProfile) {
              ...
              if (emailProfile) {
                ...
                console.log("🆕 New user - creating profile from Apple data...");

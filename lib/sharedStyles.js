...
// R/HOOD Brand Colors - Dark Theme
export const COLORS = {
  ...
  TRACK_GREY: "hsl(0, 0%, 22%)",
  /** Alias for older references / Hermes hot-reload edge cases */
  TRACK_BG: "hsl(0, 0%, 22%)",
...
export const TYPOGRAPHY = {
  ...
  // Use the actual font family name (matches useFonts key)
  bold: "TS Block Bold",
  brand: "TS Block Bold",

  // Font Sizes (reduced for better hierarchy)
  xs: 10,
  sm: 12,
  base: 14,
  lg: 16,

...
/** @typedef {{ threadId?: string | null, messages: unknown[], otherUser?: unknown, communityData?: unknown, memberCount?: number, isConnected?: boolean, canCompose?: boolean, connectionStatus?: string | null }} MessageThreadSnapshot */
...
export function setMessageThreadSnapshot(userId, chatType, djId, communityId, snapshot) {
  ...
  snapshots.set(key, {
    ...
    canCompose: snapshot.canCompose ?? snapshot.isConnected,

...
export const db = {
  ...
  async getOpportunities() {
    const { data, error } = await supabase
      .from("opportunities")
      .select(
        "id, title, description, event_date, event_start_time, event_end_time, location, city, venue, payment, payment_currency, genre, skill_level, organizer_name, image_url, is_active, created_at"
      )
      .order("created_at", { ascending: false });

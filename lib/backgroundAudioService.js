...
// Import Audio from expo-audio (the new package)
import { Audio } from "expo-audio";
console.log("✅ Audio module imported from expo-audio");
    ...
    try {
      ...
      this.notificationId = await Notifications.scheduleNotificationAsync({
        content: {
          ...
          subtitle: this.currentTrack.artist || "Unknown DJ",
          body: this.currentTrack.genre || "Electronic Music",
          data: {
            type: "audio_playback",
          ...
          ...(Platform.OS === "ios" && {
            ...
            badge: null, // No badge for media notifications
      ...
      console.log("📱 Lock screen notification shown with media info:", {

...
export default function EditProfileScreen({ user, onSave, onCancel }) {
  ...
  const availableGenres = [
    ...
    'Disco', 'Funk', 'Soul', 'Hip Hop', 'R&B', 'Pop', 'Rock',
    'Electronic', 'Experimental', 'Minimal', 'Acid', 'Hardcore',
    'Hardstyle', 'Psytrance', 'Goa', 'Chillout', 'Lounge'
  ];
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedProfile = {
        ...
        bio: profile.bio.trim() || `DJ from ${profile.city} specializing in ${profile.genres.join(', ')}`,
  ...
  const handleImagePicker = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'Remove Image', onPress: () => setProfile(prev => ({ ...prev, profile_image_url: null })) },
          ...
          <View style={styles.formSection}>
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setProfile(prev => ({ ...prev, dj_name: text }))}
            ...
            <View style={styles.inputGroup}>
              ...
              <TouchableOpacity
                style={[styles.genreSelector, errors.genres && styles.inputError]}
                onPress={() => setShowGenreModal(true)}
              >
                <Text style={[
                  styles.genreSelectorText,
                  profile.genres.length === 0 && styles.genreSelectorPlaceholder
                ]}>
                  {profile.genres.length === 0 
                    ? 'Select genres' 
                    : `${profile.genres.length} genre${profile.genres.length === 1 ? '' : 's'} selected`
                  }
                </Text>
                ...
                <View style={styles.selectedGenres}>
                  {profile.genres.map((genre) => (
                    <View key={genre} style={styles.genreTag}>
                      ...
                      >
                        <Ionicons name="close" size={16} color="hsl(0, 0%, 100%)" />
                      </TouchableOpacity>
                    </View>
                  ))}
                </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                onChangeText={(text) => setProfile(prev => ({ ...prev, soundcloud: text }))}

...
const mockForumPosts = [
  ...
  },
  {
    ...
    content: "Looking for a producer to collaborate on a new track. Hit me up if you're interested in deep house vibes!",
    likes: 12,
    replies: 3,
    isPinned: false,
  ...
  },
  {
    ...
    content: "The new venue in Shoreditch is amazing! Perfect acoustics for electronic music. Highly recommend checking it out.",
    likes: 18,
    replies: 5,
    isPinned: false,
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerInfo}>
            ...
            <View style={styles.groupDetails}>
              ...
              <Text style={styles.groupSubtitle}>12 members • Community Forum</Text>
            </View>
          </View>
        ...
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerInfo}>
            <View style={styles.djImageContainer}>
              <Image source={{ uri: currentDJ.profileImage }} style={styles.djImage} />
            ...
            <View style={styles.djDetails}>
              ...
              <View style={styles.djLocation}>
                <Ionicons name="location-outline" size={12} color="hsl(0, 0%, 70%)" />
        ...
        <View style={styles.djInfoCard}>
          <View style={styles.djInfoHeader}>
            <View style={styles.djInfoTitle}>
              <Ionicons name="musical-notes" size={16} color="hsl(75, 100%, 60%)" />
          ...
          >
            <View
              style={[
                ...
                message.isCurrentUser ? styles.messageBubbleRight : styles.messageBubbleLeft
              ]}
            >
              <Text style={[
                styles.messageText,
                message.isCurrentUser ? styles.messageTextRight : styles.messageTextLeft
              ]}>
                {message.text}
              </Text>
              <Text style={[

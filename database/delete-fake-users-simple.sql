-- ============================================================================
-- DELETE FAKE/TEST USERS - SIMPLIFIED VERSION
-- This script removes all fake test users from the database
-- Only keeps real user accounts (Eloka)
-- ============================================================================

-- Delete from message_threads where fake users are participants
...
-- Delete any messages involving fake users (if messages table exists)
...
-- FINALLY: Delete fake users from user_profiles table
